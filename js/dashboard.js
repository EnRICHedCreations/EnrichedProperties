                    ...
                    return buyer ? `
                        <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                            ...
                            <div class="flex space-x-2">
                                <button onclick="contactSingleBuyer('${buyer.email}', '${buyer.phone}', '${deal.propertyAddress}')"
...
function contactSingleBuyer(email, phone, propertyAddress) {
    const subject = `Investment Opportunity: ${propertyAddress}`;
