        ...
        tableBody.innerHTML = wholesaleDeals.map(deal => {
            ...
            return `
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${deal.matchingBuyers > 0 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}">
                            ${deal.matchingBuyers || 0} matches
                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button onclick="viewDealDetails(${deal.id})" class="text-indigo-600 hover:text-indigo-900 mr-3">View</button>
                        <button onclick="updateDealStatus(${deal.id})" class="text-blue-600 hover:text-blue-900 mr-3">Update</button>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div><strong>Price:</strong> $${parseInt(deal.price).toLocaleString()}</div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div><strong>Matching Buyers:</strong> ${deal.matchingBuyers || 0}</div>
